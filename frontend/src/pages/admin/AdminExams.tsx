...
export const MOCK_EXAM_VIGNETTES: ExamVignette[] = [
  {
    id: 'vign-601',
    code: 'Q-01',
    topic: 'Cranial Ballistics & PMCT',
    difficulty: 'Board Level',
    questionPreview: 'A 42-year-old male presenting with gunshot injury to the right temporal fossa...',
    correctAnswer: 'Bevelling on the inner table of skull indicates entry wound.',
  },
  {
    id: 'vign-602',
    code: 'Q-02',
    topic: 'PMCTA Coronary Artery Stenosis',
    difficulty: 'Board Level',
    questionPreview: 'Multi-slice contrast-enhanced post-mortem CT angiogram reveals non-filling of LAD...',
    correctAnswer: 'Acute calcific plaque disruption with thrombosis.',
  },
  {
    id: 'vign-603',
    code: 'Q-03',
    topic: 'Blunt Force Abdominal Trauma',
    difficulty: 'Advanced',
    questionPreview: 'Hyperdense intra-peritoneal fluid accumulation with gas foci adjacent to the duodenum...',
    correctAnswer: 'Traumatic retroperitoneal duodenal rupture.',
  },
  {
    id: 'vign-604',
    code: 'Q-04',
    topic: 'Thermal & Burn Pathology',
    difficulty: 'Core',
    questionPreview: 'Post-mortem CT shows epidural hyperdense crescentic rim in charred remains...',
    correctAnswer: 'Thermal heat hematoma secondary to calvarial baking.',
  },
];
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Exam Question Bank</p>
              <h3 className="text-2xl font-black text-[#0A192F] mt-1">60 Vignettes</h3>
            </div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-amber-600 mt-1">{passMark}% Passing Score</h3>
            </div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-black text-sky-600 mt-1">14 Fellows</h3>
            </div>
          ...
          <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">AI Proctor Security</p>
              <h3 className="text-2xl font-black text-emerald-600 mt-1">100% Shielded</h3>
            </div>
